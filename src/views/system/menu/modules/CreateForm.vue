<template>
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="open" @close="onClose">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      ...
      <a-form-model-item label="是否开放APP菜单" prop="isApp" v-if="form.menuType != 'F'">
        <a-radio-group v-model="form.isApp" button-style="solid">
          <a-radio-button value="0">开放</a-radio-button>
          <a-radio-button value="1">不开放</a-radio-button>
        </a-radio-group>
      </a-form-model-item>
...
<script>
import { getMenu, addMenu, updateMenu } from '/src/api/system/menu.js'
