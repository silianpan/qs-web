  ...
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="openDataScope" @close="onClose">
    ...
    <a-form-model ref="form" :model="form">
      ...
      <div class="bottom-control">
        <a-space>
          <a-button type="primary" @click="submitDataScope"> 保存 </a-button>
...
<script>
import { getRole, dataScope } from '/src/api/system/role.js'
import { treeselect as deptTreeselect, roleDeptTreeselect } from '/src/api/system/dept.js'
