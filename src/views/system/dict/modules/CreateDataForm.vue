<template>
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="open" @close="onClose">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      ...
      <a-form-model-item label="表格回显样式" prop="listClass">
        <a-input v-model="form.listClass" placeholder="请输入表格回显样式" />
      </a-form-model-item>
      <a-form-model-item label="样式属性（其他样式扩展）" prop="cssClass">
        <a-input v-model="form.cssClass" placeholder="请输入样式属性（其他样式扩展）" />
      </a-form-model-item>
...
<script>
import { getData, addData, updateData } from '/src/api/system/dict/data.js'
