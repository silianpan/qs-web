  ...
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="open" @close="onClose">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      ...
      <a-form-model-item label="部门" prop="deptId">
        <a-tree-select v-model="form.deptId" style="width: 100%" :dropdown-style="{ maxHeight: '400px', overflow: 'auto' }" :tree-data="deptOptions" placeholder="请选择" :replaceFields="replaceFields" tree-default-expand-all>
        </a-tree-select>
      </a-form-model-item>
...
<script>
import { getUser, addUser, updateUser } from '/src/api/system/user.js'
