<template>
  <div class="account-settings-info-view">
    <a-row :gutter="16">
      <a-col :md="24" :lg="16">
        <a-form layout="vertical" :rules="rules" :model="user" ref="form">
          <a-form-item label="昵称" ref="nickName" prop="nickName" :required="true">
          ...
          <a-form-item label="电子邮件" :required="true">
      ...
      <a-col :md="24" :lg="8" :style="{ minHeight: '180px' }">
        <div class="ant-upload-preview" @click="$refs.modal.edit(1)">
          ...
          <img @error="handleImgError" :src="avatar" />
        </div>
      </a-col>
    </a-row>
...
import { getUserProfile, updateUserProfile } from '/src/api/system/user.js'
