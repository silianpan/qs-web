...
import BudgetUseDetail from './BudgetUseDetail.vue'
  ...
  methods: {
    ...
    handleUseMoney(row) {
      this.$createAntdDrawer({
        ...
        content: {
          template: BudgetUseDetail,
          props: {
            projectId: row.projectId,
            projectCode: this.budgetUserList[0].sealProject.code,
            budgetType: row.type,
            expenseType: row.sealBudgetType.name,
            budgetTypeId: row.typeId
          }
        }
      })
    }
