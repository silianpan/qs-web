...
<template>
  <a-card :bordered="false">
    <!-- 数据表格 -->
    <a-card title="公司资金收支汇总" :bordered="false" :headStyle="{ fontSize: '20px', fontWeight: 'bold', textAlign: 'center' }"> </a-card>
...
import CompanyRealBie from './companyRealBie.vue'
