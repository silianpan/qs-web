export default {
    ...
    'app.setting.breadcrumb': 'View breadcrumb',
    'app.setting.footerView': 'View Footer',
    'app.setting.showFirstLevelMenu': 'show first level menu on topbar',
    'app.setting.menuIconHorizontal': 'show first level icon horizontal',
